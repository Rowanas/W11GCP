        ...
        <>
            <Container className="GettingHereDiv">
                ...
                <Row row-cols="3">
                    ...
                    <img src={"./Resources/Train.JPG"} alt="Closest Train Stations to Cinema" />
                    ...
                    <Col>
                    <img src={("./Resources/CinemaMap.JPG")} alt="Cinema Map of Bartholemew Street, Exeter" />
                    </Col>
                    <Col>
                    <img src={("./Resources/CinemaFront.png")}alt="I don't care, I just want this programme to run" />
                    </Col>
